...
hi IncSearch    guifg=red               guibg=black
...
hi Search       guifg=DarkSalmon        guibg=bisque1
...
hi SignColumn	guifg=bisque    guibg=grey15	ctermfg=NONE
hi GitGutterAddDefault          guifg=khaki     guibg=NONE gui=bold ctermfg=2 ctermbg=NONE
hi GitGutterChangeDefault       guifg=khaki     guibg=NONE gui=bold ctermfg=3 ctermbg=NONE
hi GitGutterDeleteDefault       guifg=red       guibg=NONE gui=bold ctermfg=1 ctermbg=NONE

"Syntax hilight groups

hi Comment      guifg=tan gui=italic
