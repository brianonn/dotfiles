...
hi VertSplit	guifg=grey50	guibg=#c2bfa5	gui=NONE	ctermfg=lightgray		ctermbg=black	cterm=NONE
hi StatusLine   guifg=black		guibg=#c2bfa5   gui=NONE    ctermfg=black 			ctermbg=white   cterm=NONE
...
if version >= 700 " Vim 7 specific colors
  ...
  hi MatchParen	guifg=#0F2130	guibg=red					ctermfg=red		ctermbg=lightgray
...
hi SignColumn	guifg=#552f2f	guibg=#12384B	gui=bold		ctermfg=red
