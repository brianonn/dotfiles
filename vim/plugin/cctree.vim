...
" }}}
" {{{ Define commands
command! -nargs=? -complete=file -bar CCTreeLoadXRefDBFromDisk
                                        \ call s:CCTreeCmdLine.mLoadDBFromDisk(<q-args>)
command! -nargs=? -complete=file -bar CCTreeLoadDB  call s:CCTreeCmdLine.mLoadDB(<q-args>, s:DBClasses.cscopeid)
